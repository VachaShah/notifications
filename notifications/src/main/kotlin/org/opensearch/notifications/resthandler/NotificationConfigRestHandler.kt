...
internal class NotificationConfigRestHandler : PluginBaseHandler() {
    companion object {
        ...
        private val FILTER_PARAMS = setOf(IS_ENABLED_TAG, CONFIG_TYPE_TAG, FEATURES_TAG, NAME_TAG)
    }
    ...
    override fun responseParams(): Set<String> {
        return setOf(CONFIG_ID_TAG, CONFIG_ID_LIST_TAG, SORT_FIELD_TAG, SORT_ORDER_TAG, FROM_INDEX_TAG, MAX_ITEMS_TAG)
    }
    ...
    override fun executeRequest(request: RestRequest, client: NodeClient): RestChannelConsumer {
        return when (request.method()) {
            POST -> executePostRequest(client, request)
            PUT -> executePutRequest(client, request)
