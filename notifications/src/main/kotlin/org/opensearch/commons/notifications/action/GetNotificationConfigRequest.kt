...
import org.opensearch.commons.notifications.NotificationConstants.FILTER_PARAMS_TAG
...
class GetNotificationConfigRequest : ActionRequest, ToXContentObject {
        ...
        fun parse(parser: XContentParser): GetNotificationConfigRequest {
            ...
            while (parser.nextToken() != XContentParser.Token.END_OBJECT) {
                ...
                when (fieldName) {
                    ...
                    FILTER_PARAMS_TAG -> filterParams = parser.mapStrings()
                    else -> {
                        parser.skipChildren()
    ...
    override fun toXContent(builder: XContentBuilder?, params: ToXContent.Params?): XContentBuilder {
        ...
        return builder.startObject()
            ...
            .field(FILTER_PARAMS_TAG, filterParams)
            .endObject()
    }
